...
// ordering.
LargeBits Verifier::GetQualityString(
    uint8_t k,
    LargeBits proof,
...
LargeBits Verifier::ValidateProof(
    const uint8_t* id,
    uint8_t k,
    const uint8_t* challenge,
...
bool Verifier::CompareProofBits(const LargeBits& left, const LargeBits& right, uint8_t k)
{
