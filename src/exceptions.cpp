...
// InsufficientMemoryException::InsufficientMemoryException(std::string ss) : s(ss) {}

// InsufficientMemoryException::~InsufficientMemoryException() throw() {}  // Updated

// const char* InsufficientMemoryException::what() const throw() { return s.c_str();
